 ...
 * IirfVersion.c
 *
 * Version query utility for IIRF. 
 * This module links to the ISAPI filter DLL, and prints out the version of the library. 
...
extern char * Iirf_GetVersion();

void Usage()
{
    printf("\nIirfVersion.exe\n");
    printf("  prints the version of  IIRF. Run it with no arguments.\n\n");
}
